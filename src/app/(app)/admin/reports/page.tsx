  ...
  return (
    <>
      ...
      <div className="mt-6 space-y-4">
        {reports.length === 0 ? (
          <p className="py-8 text-center text-sm text-zinc-500">Nema prijava</p>
        ) : (
          reports.map((report) => (
            <div
              key={report.id}
                ...
                {report.status === 'PENDING' && (
                  <div className="flex gap-2 shrink-0">
                    ...
                    <button
                      ...
                      disabled={updatingId === report.id}
                      className="cursor-pointer rounded-lg bg-zinc-200 px-3 py-1.5 text-xs font-medium text-zinc-700 hover:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-600 disabled:opacity-50"
                    >
                      Odbaci
                    </button>
                  </div>
