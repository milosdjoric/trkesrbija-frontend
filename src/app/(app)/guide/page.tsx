...
export const metadata: Metadata = {
  ...
  description: 'Korisnički vodič za platformu Trke Srbija — kako pronaći trke, prijaviti se, pratiti rezultate i koristiti sve funkcionalnosti.',
}
...
export default function GuidePage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      {/* Table of contents */}
      <nav className="mt-8 rounded-xl border border-border-primary bg-surface p-5">
        <p className="mb-3 text-sm font-semibold text-text-primary">Sadržaj</p>
        <ul className="grid grid-cols-2 gap-x-6 gap-y-1.5 sm:grid-cols-3">
          {sections.map((s) => (
            <li key={s.id}>
              <a href={`#${s.id}`} className="text-sm text-brand-green hover:underline">
                {s.label}
              </a>
            </li>
          ))}
      ...
      <div className="mt-12 space-y-14">
        ...
        <Section id="dogadjaji" title="Događaji i trke">
          <H3>Svi događaji</H3>
          <P>
            Na stranici <InternalLink href="/events">Svi događaji</InternalLink> možeš pretražiti i filtrirati sve trke
            u Srbiji:
          </P>
          <Ul>
        ...
        <Section id="rezultati" title="Rezultati">
          <P>
            Nakon završetka trke, rezultati se objavljuju na stranici trke. Tabela sa rezultatima prikazuje:
          </P>
          <Ul>
        ...
        <Section id="treninzi" title="Treninzi">
          <P>
            Na stranici <InternalLink href="/training">Moji treninzi</InternalLink> možeš kreirati privatne treninge sa
            GPX fajlovima. Ovo je korisno za planiranje ruta i praćenje treninga.
          </P>
          <Ul>
        ...
        <Section id="sudije" title="Sudijska tabla">
          ...
          <P>
            Status bar prikazuje da li si online ili offline i koliko stavki čeka na sinhronizaciju.
          </P>
        </Section>
      ...
      {/* Back to top */}
      <div className="mt-16 border-t border-border-primary pt-6 text-center">
