    ...
    <Headless.Listbox {...props} multiple={false}>
      <Headless.ListboxButton
        ...
        className={clsx([
          ...
          // Disabled state
          'data-disabled:opacity-50 data-disabled:before:shadow-none',
        ])}
      >
        <Headless.ListboxSelectedOption
          ...
          className={clsx([
            ...
            // Disabled state
            'group-data-disabled:border-white/15 group-data-disabled:opacity-100 group-data-disabled:bg-white/2.5 group-data-disabled:data-hover:border-white/15',
          ])}
        />
        <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
          <svg
            className="size-5 stroke-gray-400 group-data-disabled:stroke-zinc-600 sm:size-4 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
