    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'Trail trke',
        description: 'Pronađite sve trail trke u Srbiji - planinske i brdske staze',
        url: `${siteUrl}/events?type=TRAIL`,
      },
      {
        '@type': 'SiteNavigationElement',
        position: 2,
        name: 'Ulične trke',
        description: 'Pronađite sve ulične trke u Srbiji - maratoni, polumaratoni',
        url: `${siteUrl}/events?type=ROAD`,
      },
      {
        '@type': 'SiteNavigationElement',
        position: 3,
