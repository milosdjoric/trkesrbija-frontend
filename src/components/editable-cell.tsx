  ...
  if (!isEditing) {
    return (
      <div
        ...
        className={clsx(
          'min-h-[28px] cursor-pointer rounded px-2 py-1 transition-colors',
    ...
    <div className="relative">
      {type === 'select' ? (
        <select
          ...
          disabled={isSaving}
          className="w-full rounded border-2 border-blue-500 bg-white px-2 py-1 text-sm focus:outline-none dark:bg-zinc-800"
        >
          <option value="">-</option>
          {options?.map((opt) => (
